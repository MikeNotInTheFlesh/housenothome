...
HouseNotHome.Preloader = function (game) {
...
HouseNotHome.Preloader.prototype = {
	...
	preload: function () {
		...
		// this.load.spritesheet('tiles', 'assets/images/tiles96.png', 96, 96);
		// this.load.spritesheet('things', 'assets/images/things.png', 16, 16);
		this.load.spritesheet('things', 'assets/images/things96.png', 96, 96);
